...
To close the enviroment and the whole simulation, press `Ctrl+C` and enter `gazebo-2` in the same terminal where the command `roslaunch assignment_2_2023 assignment1.launch` was launched. 
